  ...
  return (
    <div className='contact-container'>
      ...
      <div className='div2-contact'>
        ...
        <img className='d2-img1-contact' src={instaLogo} alt='insta_pic' width='30vw' height='30vh' onClick={() => window.open('https://www.instagram.com/tarun_sai_rayapureddi/', '_blank')}></img>
        <img className='d2-img1-contact' src={linkedinLogo} alt='linkedin_pic' width='30vw' height='30vh' onClick={() => window.open('https://www.linkedin.com/in/tarunsai-rayapureddi-22b329215/', '_blank')}></img>
        <img className='d2-img1-contact' src={gmailLogo} alt='gmail_pic' width='30vw' height='30vh' onClick={handleClickEmail}></img>
        <img className='d2-img1-contact' src={gitLogo} alt='github_pic' width='30vw' height='30vh' onClick={() => window.open('https://github.com/tarunsai2912', '_blank')}></img>
      </div>
    </div>
  )
}
